...
console.log(i);
var playPreviousTrackButton = document.getElementById("#play-previous"),
...
function selectTrack(flag) {
  ...
  if (currIndex > -1 && currIndex < songs.length) {
    ...
    document.getElementById("#album-art img").prop("src", bgArtworkUrl);
  } else {
    if (flag == 0 || flag == 1) --currIndex;
    else ++currIndex;
  }
...
function initPlayer() {
  ...
  document.getElementById(audio).on("timeupdate", updateCurrTime);
